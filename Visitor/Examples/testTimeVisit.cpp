...
typedef MM::Prototype<TestDisp1, int,
                        ...
                        std::chrono::high_resolution_clock::time_point&, std::ostream&> Proto1;

class B1
{
public:
  MAKE_ACCEPTABLE_DECL(Proto1, Param1List, B1);
};

class D11 : public B1
{
public:
  MAKE_ACCEPTABLE_DECL(Proto1, Param1List, D11);
};

class D12 : public B1
{
public:
  MAKE_ACCEPTABLE_DECL(Proto1, Param1List, D12);
};

class D13 : public D11
{
public:
  MAKE_ACCEPTABLE_DECL(Proto1, Param1List, D13);
};
...
{
public:
  MAKE_ACCEPTABLE_DECL(Proto1, Param2List, B2);
};

class D21 : public B2
{
public:
  MAKE_ACCEPTABLE_DECL(Proto1, Param2List, D21);
};

class D22 : public D21
{
public:
  MAKE_ACCEPTABLE_DECL(Proto1, Param2List, D22);
};

class D23 : public B2
{
public:
  MAKE_ACCEPTABLE_DECL(Proto1, Param2List, D23);
};
...
MAKE_ACCEPTABLE_IMPL(Proto1, Param1List, B1);
MAKE_ACCEPTABLE_IMPL(Proto1, Param1List, D11);
MAKE_ACCEPTABLE_IMPL(Proto1, Param1List, D12);
MAKE_ACCEPTABLE_IMPL(Proto1, Param1List, D13);
MAKE_ACCEPTABLE_IMPL(Proto1, Param1List, D14);
MAKE_ACCEPTABLE_IMPL(Proto1, Param2List, B2); 
MAKE_ACCEPTABLE_IMPL(Proto1, Param2List, D21);
MAKE_ACCEPTABLE_IMPL(Proto1, Param2List, D22);
MAKE_ACCEPTABLE_IMPL(Proto1, Param2List, D23);
